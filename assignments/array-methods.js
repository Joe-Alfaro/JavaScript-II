...
// Problem 1
let specificCompany = runners.filter((runner) => runner.company_name === "Wordtune");
console.log(specificCompany);


// Problem 2
let donationsAbove = runners.filter((runner) => runner.donation > 200);
console.log(donationsAbove);

// Problem 3
let jerseyInfo = [];
runners.forEach((runner) => jerseyInfo.push(`${runner.shirt_size} - ${runner.last_name}`));
